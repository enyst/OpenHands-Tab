...
See `AGENTS.md` for contribution guidelines, `packages/agent-sdk-ts/AGENTS.md` for detailed SDK documentation, and `docs/agent-sdk-architecture.md` for comprehensive architecture details.
